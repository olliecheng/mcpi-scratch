...
sed -i -e "s/Exec=.*/Exec=$(realpath mcpi-scratch/mcpi-scratch-server.py | sed 's_/_\\/_g')/" installfiles/mcpi-scratch-server.desktop
cp installfiles/mcpi-scratch-server.desktop ~/.local/share/applications/
cp installfiles/mcpi-scratch-server.desktop ~/Desktop
